#
# Be sure to run `pod spec lint KVOHelper.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.authors      = { "zhangchiqing" => "zhangchiqing@gmail.com", "other author" => "and email address" }
  #
  # If absolutely no email addresses are available, then you can use this form instead.
  #
  # s.author       = 'zhangchiqing', 'other author'
